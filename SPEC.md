...
<!-- generated:version -->
This document specifies **RepoPact 0.1.0**.
<!-- /generated:version -->

> Status: **alpha**. The record formats and rules below are stable enough to build
> against, but may change before 1.0 in response to adopter evidence.
>
