...
RepoPact 3.1.3 is available on PyPI and the project is open source under Apache 2.0:
...
The stable package is RepoPact 3.1.3 and the project is Apache-2.0:
https://github.com/ForgeWireLabs/repopact
...
- Stable package claims refer to **3.1.3** unless a later release is actually published.
