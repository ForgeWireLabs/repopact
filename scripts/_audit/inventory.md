...
| scripts/run_conformance.py | tooling-owner | 2026-07-18 | current | 2026-10-16 | Materializes the published fixture corpus, enforces bidirectional rule/case coverage, isolates each reject fixture to one primary reference diagnostic, and runs the same cases against alternative implementations. |
