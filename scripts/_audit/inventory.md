...
| --- | --- | --- | --- | --- | --- |
| scripts/validate_repo.py | tooling-owner | 2026-06-29 | current | 2026-09-29 | Schema (jsonschema) + semantic validation: contracts, invariants, frozen surface, roles, findings, work lifecycle including proposed-authority dependencies, cycles, evidence, decisions, policies, version. |
...
| scripts/repopact_cli.py | tooling-owner | 2026-06-29 | current | 2026-09-29 | `repopact` console entry point dispatching init/validate/new/dashboard/spec/check-frozen; `new work-item` accepts `--status`. |
